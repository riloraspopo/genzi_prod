...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1265: (x0,x1) => x0.registerCallback(x1),
      _1266: (x0,x1) => x0.unregisterCallback(x1),
      _1267: (x0,x1) => x0.createElement(x1),
      _1268: (x0,x1) => x0.querySelector(x1),
      _1269: (x0,x1) => x0.appendChild(x1),
      _1270: x0 => ({type: x0}),
      _1271: (x0,x1) => new Blob(x0,x1),
      _1272: x0 => globalThis.URL.createObjectURL(x0),
      _1273: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1273(f,arguments.length,x0,x1) }),
      _1274: (x0,x1,x2,x3) => x0.sendCommand(x1,x2,x3),
      _1275: () => globalThis.PdfiumWasmCommunicator,
      _1277: x0 => { globalThis.pdfiumWasmWorkerUrl = x0 },
      _1278: (x0,x1) => x0.writeText(x1),
      _1279: x0 => x0.preventDefault(),
      _1280: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1280(f,arguments.length,x0) }),
      _1281: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1282: x0 => globalThis.URL.revokeObjectURL(x0),
      _1283: x0 => x0.remove(),
      _1284: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      ...
      _1290: (x0,x1) => x0.append(x1),
      _1291: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1292: (x0,x1) => x0.replaceChildren(x1),
      _1293: x0 => x0.click(),
      ...
      _1307: x0 => x0.play(),
      _1308: x0 => x0.pause(),
      _1310: (x0,x1) => x0.removeAttribute(x1),
      _1312: (x0,x1) => x0.start(x1),
      _1313: (x0,x1) => x0.end(x1),
      ...
      _1325: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1333: (x0,x1) => x0.getContext(x1),
      _1335: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      _1338: Date.now,
      ...
      _1473: () => new AbortController(),
      _1474: x0 => x0.abort(),
      _1475: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1476: (x0,x1) => globalThis.fetch(x0,x1),
      _1477: (x0,x1) => x0.get(x1),
      _1478: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1478(f,arguments.length,x0,x1,x2) }),
      _1479: (x0,x1) => x0.forEach(x1),
      _1480: x0 => x0.getReader(),
      _1481: x0 => x0.read(),
      _1482: x0 => x0.cancel(),
      _1484: () => new XMLHttpRequest(),
      _1485: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1486: x0 => x0.send(),
      _1488: () => new FileReader(),
      _1489: (x0,x1) => x0.readAsArrayBuffer(x1),
      ...
      _1590: () => globalThis.window,
      _1595: (x0,x1) => { x0.height = x1 },
      _1597: (x0,x1) => { x0.width = x1 },
      _1600: x0 => x0.head,
      _1601: x0 => x0.classList,
      _1605: (x0,x1) => { x0.innerText = x1 },
      _1606: x0 => x0.style,
      _1608: x0 => x0.sheet,
      _1609: x0 => x0.src,
      ...
      _1680: (x0,x1) => { x0.responseType = x1 },
      _1681: x0 => x0.response,
      _1757: x0 => x0.style,
      _1770: (x0,x1) => { x0.oncancel = x1 },
      _1776: (x0,x1) => { x0.onchange = x1 },
      _1816: (x0,x1) => { x0.onerror = x1 },
      _2010: x0 => x0.content,
      _2189: (x0,x1) => { x0.src = x1 },
      _2200: x0 => x0.width,
      _2202: x0 => x0.height,
      _2234: (x0,x1) => { x0.src = x1 },
      ...
      _2988: x0 => x0.src,
      _2989: (x0,x1) => { x0.src = x1 },
      _2991: (x0,x1) => { x0.type = x1 },
      _2995: (x0,x1) => { x0.async = x1 },
      _3009: (x0,x1) => { x0.charset = x1 },
      _3033: x0 => x0.width,
      _3034: (x0,x1) => { x0.width = x1 },
      _3035: x0 => x0.height,
      _3036: (x0,x1) => { x0.height = x1 },
      _3456: () => globalThis.window,
      _3496: x0 => x0.document,
      _3499: x0 => x0.location,
      _3518: x0 => x0.navigator,
      _3782: x0 => x0.localStorage,
      _3790: x0 => x0.href,
      _3886: x0 => x0.clipboard,
      ...
      _8070: x0 => x0.type,
      _8077: x0 => x0.name,
      _8078: x0 => x0.lastModified,
      _8083: x0 => x0.length,
      _8089: x0 => x0.result,
      _8586: x0 => x0.url,
      _8588: x0 => x0.status,
      _8590: x0 => x0.statusText,
      _8591: x0 => x0.headers,
      _8592: x0 => x0.body,
      _10719: (x0,x1) => { x0.border = x1 },
      _10997: (x0,x1) => { x0.display = x1 },
      _11161: (x0,x1) => { x0.height = x1 },
      _11851: (x0,x1) => { x0.width = x1 },
      _12219: x0 => x0.name,
      _12220: x0 => x0.message,
